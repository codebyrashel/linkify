    ...
    return (
        <div className="space-y-4">
            {links.map((link) => (
                ...
                >
                    <div className="relative bg-white/70 hover:bg-white/90 border border-slate-200 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:shadow-slate-900/5 hover:-translate-y-0.5 group">
